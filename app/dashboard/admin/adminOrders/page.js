...
export default function OrderListPage() {
    ...
    const confirmRepeat = async () => {
        ...
        router.push(`/dashboard/admin/adminOrders/addOrder?repeat=${repeatOrderId}`);
    ...
    useEffect(() => {
        ...
        axios
            ...
            .then((res) => {
                ...
                setOrders((res.data?.data || []).filter(o => o.creatorRole === 'admin'));
            })
            .catch((err) => {
                if (mounted) {
        ...
        const handler = async (e) => {
            try {
                ...
                if (!id) {
                    ...
                    // preserve admin-only filter when refreshing list
                    setOrders((res.data?.data || []).filter(o => o.creatorRole === 'admin'));
                    return;
                }
                ...
                if (res.data?.success) {
                    ...
                    // if the updated sale is created by admin, update/add it; otherwise remove it
                    if (updated.creatorRole === 'admin') {
                        setOrders((prev) => (prev.some(o => o._id === updated._id) ? prev.map((o) => (o._id === updated._id ? updated : o)) : [...prev, updated]));
                    } else {
                                        ...
                                        <td>
                                            <div className="flex justify-center gap-2">
                                                ...
                                                <button
                                                    ...
                                                    onClick={() => router.push(`/dashboard/admin/adminOrders/edit/${o._id}`)}
