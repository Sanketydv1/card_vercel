...
function AddOrderPageContent() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // upload files via multipart/form-data (cardPhoto + uploadZip/uploadExcel entries)
            let uploaded = [];
            ...
            if (res.data?.success) {
                ...
                removeCardPhoto();
                setCardPhotoPreview(null);
                // notify orders list and redirect
        ...
        <div className="min-h-screen flex items-center justify-center">
            <div className="w-full max-w-6xl bg-white rounded-xl shadow-xl overflow-hidden p-6">
                <div className="flex items-center justify-between mb-4">
                    <h2 className="text-lg font-semibold">Add Card Order</h2>
                    <div className="flex items-center gap-2">
                        <button onClick={() => router.push("/dashboard/sales/orders")} className="px-3 py-1 rounded border">Back</button>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid grid-cols-1 gap-4">
                        ...
                        <div>
                            ...
                            <select value={dataType} onChange={(e) => {
                                ...
                                setDataType(v);
                                // if fixed, clear upload fields and related errors
                                if (v !== 'Variable') {
                                    setExcelFiles([]);
                                    setZipFile(null);
                        ...
                        <div className="border rounded-lg p-4 bg-white shadow-sm">
                            <label className="text-sm font-semibold text-gray-700">
                                Upload Card Photo <span className="text-red-600">*</span>
                            </label>
                            ...
                            <input
                                ...
                                className={`mt-2 block w-full text-sm
                                             ...
                                             file:bg-indigo-50 file:text-indigo-700
                                             hover:file:bg-indigo-100 cursor-pointer
                                             ${errors.cardPhoto ? 'border border-red-500 rounded-md p-1' : ''}
                                           `}
                            />
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="flex items-center gap-3 mt-4">
                            ...
                            <button type="button" onClick={() => router.push("/dashboard/sales/orders")} className="px-4 py-2 border rounded">Cancel</button>
                        </div>
                    </div>
                </form>
            </div>
